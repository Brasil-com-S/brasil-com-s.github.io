...
# Master List of 36 Samba Schools (RJ & SP - Grupo Especial & Acesso)
escolas = [
    # --- RIO DE JANEIRO (GRUPO ESPECIAL) ---
    {
        ...
        "sambas_enredo": [
            ...
            {"ano": 2019, "titulo": "História pra Ninar Gente Grande", "compositores": "Deivid Domênico, Tomaz Miranda", "interpretacao": "Marquinho Art'Samba"},
    ...
    },
    {
        ...
        "sambas_enredo": [
            {"ano": 2024, "titulo": "Um Delírio de Carnaval na Maceió de Rás Gonguila", "compositores": "Kirizinho, Lucas Guedes", "interpretacao": "Nego"},
            {"ano": 2018, "titulo": "Monstro É Aquele Que Não Sabe Amar", "compositores": "Di Menor FM, Kirizinho", "interpretacao": "Nego"},
            {"ano": 1989, "titulo": "Ratos e Urubus, Comprem Meu Vazio", "compositores": "Glyvis, Betinho", "interpretacao": "Nego"}
        ],
        "colocacoes": [
    ...
    },
    {
        ...
        "sambas_enredo": [
            ...
            {"ano": 1993, "titulo": "Peguei Um Ita no Norte", "compositores": "Demá Chagas, Arizão", "interpretacao": "Quinho"}
        ],
        "colocacoes": [
    ...
    },
    {
        ...
        "sambas_enredo": [
            ...
            {"ano": 2013, "titulo": "A Vila Canta o Brasil Celeiro do Mundo", "compositores": "Martinho da Vila, Arlindo Cruz", "interpretacao": "Tingua"}
        ],
        "colocacoes": [
    ...
    },
    {
        ...
        "sambas_enredo": [
            {"ano": 2024, "titulo": "Pede Caju Que Dou... Pé de Caju Que Dá!", "compositores": "Paulinho Mocidade, Diego Nicolau", "interpretacao": "Zé Paulo Sierra"},
            {"ano": 2017, "titulo": "Elza Deusa Soares", "compositores": "Gonzaguinha, Jefinho Rodrigues", "interpretacao": "Wander Pires"}
        ],
        "colocacoes": [
            {"ano": 2024, "grupo": "Especial", "posicao": 10, "pontos": 267.9},
            {"ano": 2017, "grupo": "Especial", "posicao": 1, "pontos": 269.8}
        ]
    },
    {
        ...
        "anos_titulos": [],
        "sambas_enredo": [
            {"ano": 2024, "titulo": "Kituco: A Filosofia do Samba", "compositores": "Claudio Russo, Moacyr Luz", "interpretacao": "Pixulé"},
            {"ano": 2018, "titulo": "Meu Deus, Meu Deus, Está Extinta a Escravidão?", "compositores": "Claudio Russo, Moacyr Luz", "interpretacao": "Canto do Tuiuti"}
        ],
        "colocacoes": [
            {"ano": 2024, "grupo": "Especial", "posicao": 9, "pontos": 268.3},
            {"ano": 2018, "grupo": "Especial", "posicao": 2, "pontos": 269.5}
        ]
    },
    {
        ...
        "anos_titulos": [],
        "sambas_enredo": [
            {"ano": 2024, "titulo": "O Redentor do Sertão", "compositores": "Claudio Russo, Junior Fionda", "interpretacao": "Bruno Ribas"}
        ],
        "colocacoes": [
    ...
    },
    {
        ...
        "anos_titulos": [1992],
        "sambas_enredo": [
            {"ano": 2024, "titulo": "Chão de Devoção: O Terço dos Pretos Velhos", "compositores": "Julio Alves, Claudio Russo", "interpretacao": "Tシャー"}
        ],
        "colocacoes": [
    ...
    # --- RIO DE JANEIRO (GRUPO DE ACESSO) ---
    {
        "id": "imperio-serrano",
    ...
    },
    {
        ...
        "anos_titulos": [],
        "sambas_enredo": [
            {"ano": 2024, "titulo": "Que Zé É Esse?", "compositores": "Marcelo Adnet, Claudio Russo", "interpretacao": "Leozinho"}
        ],
        "colocacoes": [
    ...
    # --- SÃO PAULO (GRUPO ESPECIAL) ---
    {
        ...
        "sambas_enredo": [
            ...
            {"ano": 2015, "titulo": "Simplesmente Elis - A Fábula de Uma Voz Que Voou", "compositores": "Zeca do Cavaco", "interpretacao": "Wander Pires"}
        ],
        "colocacoes": [
    ...
    },
    {
        ...
        "sambas_enredo": [
            {"ano": 2024, "titulo": "IBIRA 70 - A Festa da Vida no Parque de SP", "compositores": "Aquiles da Vila", "interpretacao": "Royce do Cavaco"}
        ],
        "colocacoes": [
    ...
    # --- SÃO PAULO (GRUPO DE ACESSO) ---
    {
        ...
        "sambas_enredo": [
            {"ano": 2024, "titulo": "Circo Macabro: O Show Não Pode Parar", "compositores": "Kadu, Nilson", "interpretacao": "Agnaldo Amaral"}
        ],
        "colocacoes": [
...
def write_json_files():
    ...
    with open("api/v1/carnavais/2024.json", "w", encoding="utf-8") as f:
        json.dump({
            "ano": 2024,
            "campea_rj": "Unidos do Viradouro",
            "campea_sp": "Mocidade Alegre",
            "resultados": [
    ...
    print("ALL 36 SCHOOLS AND ENDPOINTS WRITTEN SUCCESSFULLY!")
